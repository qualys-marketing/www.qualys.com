...
a("a[href="+b+"]").click()},0)}}),a(document).ready(function(a){var b=a(".q-qsc__nav--container");a(".js-qsc__hamburger").on("click",function(){b.hasClass("q-qsc__menu--show")?b.removeClass("q-qsc__menu--show"):b.addClass("q-qsc__menu--show")})})})(jQuery);
